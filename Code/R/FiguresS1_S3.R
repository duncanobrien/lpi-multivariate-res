...
s1a <- ggplot(subset(figure_data,metric == "multiJI" & n_spp == 5),
  ...
  theme(axis.title.x=element_blank(),
        ...
        plot.margin = margin(0.5,5.5,0.5,5.5, unit = "pt"))

s1b <- ggplot(subset(figure_data,metric == "mean_uniJI" & n_spp == 5),
              aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s1c <- ggplot(subset(figure_data,metric == "FI" & n_spp == 5),
              aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
...
s1d <-ggplot(subset(figure_data,metric == "mvi" & n_spp == 5),
             aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s1e <- ggplot(subset(figure_data,metric == "multiAR" & n_spp == 5),
              aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s2a <- ggplot(subset(figure_data,metric == "multiJI" & n_spp == 15),
                aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s2b <-  ggplot(subset(figure_data,metric == "mean_uniJI" & n_spp == 15),
               aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s2c <-  ggplot(subset(figure_data,metric == "FI" & n_spp == 15),
               aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id) +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s2d <- ggplot(subset(figure_data,metric == "mvi" & n_spp == 15),
              aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s2e <-  ggplot(subset(figure_data,metric == "multiAR" & n_spp == 15),
               aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s3a <- ggplot(subset(figure_data,metric == "multiJI" & n_spp == 25),
              aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s3b <- ggplot(subset(figure_data,metric == "mean_uniJI" & n_spp == 25),
                aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s3c <- ggplot(subset(figure_data,metric == "FI" & n_spp == 25),
             aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id) +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s3d <- ggplot(subset(figure_data,metric == "mvi" & n_spp == 25),
                aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
...
s3e <- ggplot(subset(figure_data,metric == "multiAR" & n_spp == 25),
              aes(x=stand_time, y= metric_value,col=stressed)) +
  geom_line() +
  facet_grid(ts_length~sim_id,scales = "free_y") +
  scale_color_manual(values = c("#67705F","#E3A59F"),name = "Presence\nof stress",labels = c("No","Yes")) +
